...
![取色器演示](/assets/software/tool/color-picker.gif)
...
![布局选择](/assets/software/tool/layout-picker.png)

如果上述布局选择不能满足您的需求，您也可以点击 "Custom" 选项卡进行自定义。

![自定义布局](/assets/software/tool/custom-layout.png)
...
![SVG 预览](/assets/software/tool/svg-preview.png)

![Markdown 预览](/assets/software/tool/markdown-preview.png)
...
![图片尺寸调整](/assets/software/tool/image-resizer.gif)

软件预设了大/中/小/手机等不同的常用模版，单击确定即可一键完成图片尺寸的批量调整。您也可以点击 Settings 进入设置，按自己需求的尺寸大小、是否转换格式等来配置自己的常用“模版”。

![图片尺寸调整设置](/assets/software/tool/image-resizer.png)
...
![快捷键指南](/assets/software/tool/shortcut-guide.png)
...
- 搜索
  ...
  ![搜索](/assets/software/tool/power-toys-search.png)
...
- 终端
  ...
  ![终端命令](/assets/software/tool/shell-command.png)

- 简单计算

  您可以直接输入简单的数学表达式，PowerToys Run 会直接返回结果。

  ![简单计算](/assets/software/tool/calculator.png)
