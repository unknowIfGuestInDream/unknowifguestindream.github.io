import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as n,c as a,f as e}from"./app-DWr7ih7T.js";const t={},l=e(`<h1 id="标准-i-o" tabindex="-1"><a class="header-anchor" href="#标准-i-o"><span>标准 I/O</span></a></h1><h2 id="echo" tabindex="-1"><a class="header-anchor" href="#echo"><span>echo</span></a></h2><p><code>echo</code> 命令用于将指定内容输出到显示屏(标准输出)。</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ <span class="token builtin class-name">echo</span> this is a <span class="token builtin class-name">test</span>
