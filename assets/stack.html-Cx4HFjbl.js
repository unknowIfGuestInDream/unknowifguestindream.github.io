import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as n,c as s,b as a,a as o,f as t}from"./app-BV5l8r65.js";const d={},c=o("p",null,"为了方便用户在不同目录之间切换，Bash 提供了目录堆栈功能。",-1),i=t(`<h2 id="cd" tabindex="-1"><a class="header-anchor" href="#cd"><span>cd -</span></a></h2><p>Bash 可以记忆用户进入过的目录。默认情况下，只记忆前一次所在的目录，<code>cd -</code> 命令可以返回前一次的目录。</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 当前目录是 /path/to/foo</span>
